				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Formulir Input Pasfoto</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-12 contact_col">
					<div class="contact_form">
						<div class="contact_title">Upload Fas Foto Calon Siswa</div>
...
if (isset($_POST['save'])) 
{
	...
	move_uploaded_file($lokasi0, "fas_foto/".$gambar0);
	$koneksi->query("INSERT INTO foto (id_siswa,file_foto) VALUES('$_POST[nd]','$gambar0')");
	echo "<script>alert('Foto berhasil di posting');</script>";
	echo "<script>location='ijazah.php';</script>";
}
?>
					</div>
				</div>
