				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Formulir Input Ijazah/SKHU</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-12 contact_col">
					<div class="contact_form">
						<div class="contact_title">Masukkan Scan Ijazah</div>
						<div class="contact_form_container">
							<form method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label>Ijazah/SKHU</label>
									<input type="file" class="form-control" name="gambar0">
								</div>
...
if (isset($_POST['save'])) 
{
	$gambar0=$_FILES['gambar0']['name'];
	$lokasi0=$_FILES['gambar0']['tmp_name'];
	move_uploaded_file($lokasi0, "ijazah/".$gambar0);
	$koneksi->query("INSERT INTO ijazah (id_siswa,file_ijazah) VALUES('$_POST[nd]','$gambar0')");
	echo "<script>alert('Ijazah berhasil di posting Klik OK untuk Lihat Data');</script>";
