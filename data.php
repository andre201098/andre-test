...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Data Calon Siswa</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="news">
		<div class="container">
            ...
            <tbody>
              <tr><?php $nomor=1;?>
  <?php $ambil=$koneksi->query("SELECT * FROM siswa JOIN foto ON siswa.id_siswa=foto.id_siswa JOIN ijazah ON siswa.id_siswa=ijazah.id_siswa ");?>
  <?php while($pecah=$ambil->fetch_assoc()){?>
  <tr>
    <td><?php echo $nomor;?></td>
    <td><?php echo $pecah['id_siswa'];?></td>
    <td>
      <img src="fas_foto/<?php echo $pecah['file_foto']; ?>" width="100">
    </td>
    ...
    <td><?php echo $pecah['tk'];?></td>
    <td><?php echo $pecah['ayah'];?></td>
    <td><?php echo $pecah['ibu'];?></td>
	<td><?php echo $pecah['pekerjaana'];?></td>
	<td><?php echo $pecah['pekerjaai'];?></td>
    <td><?php echo $pecah['hp'];?></td>
    <td>
      <img src="ijazah/<?php echo $pecah['file_ijazah']; ?>" width="100">
    </td>
  </tr>
  <?php $nomor++;?>
  <?php } ?>
